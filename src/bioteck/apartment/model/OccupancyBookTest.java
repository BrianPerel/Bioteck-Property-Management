...
public class OccupancyBookTest {
	...
	private Candidate renter1 = Candidate.create("124-55-0000", "Kasich", "John",
			"100 Street Drive, Langston, North America", "456-543-4543");
	private Candidate renter2 = Candidate.create("124-55-0010", "Brown", "Larry", "454 Corn Path, Omaha, Nebraska",
			"454-344-3234");
	private Candidate renter3 = Candidate.create("124-55-0020", "Paredes", "Juan", "123 Taco Road, Mexico City, Mexico",
			"323-454-3222");
	private Candidate renter4 = Candidate.create("124-55-0030", "Ostrovsky", "Lenimere", "Red Square, Moscow, Russia",
			"392-494-3232");
	...
	void init() {
		...
		this.renter2 = Candidate.create("124-55-0010", "Brown", "Larry", "454 Corn Path, Omaha, Nebraska",
				"454-344-3234");
		this.renter3 = Candidate.create("124-55-0020", "Paredes", "Juan", "123 Taco Road, Mexico City, Mexico",
				"323-454-3222");
		this.renter4 = Candidate.create("124-55-0030", "Ostrovsky", "Lenimere", "Red Square, Moscow, Russia",
				"392-494-3232");
	...
	@Test
	void calculateRentStatementTest() {
	...
	@Test
	void calculateMonthlyRevenueTest() {
